# Single Page Application - Exam 2
...
This exam has 4 separate tasks. You have 90 minutes to complete all of the tasks. If you run out of time, commit and push your work, even if it is incomplete!

The tasks are in separate folders with instructions in a README.md file. The task titles in each README are links. You can use them as a hint about what you might need to solve the corresponding task.
